...
labels =["hand"]
INPUT_DIR = '/home/YJS/image/original_image/'
OUTPUT_DIR = '/home/YJS/image/processed_image/'
...
img=cv2.imread("/home/YJS/111/1.jpg")
img=main(img)
cv2.imwrite("/home/YJS/111/2.jpg",img)
...
#     e = int(w/3)+3
#     f = int(2*w/3)-3
#     cv2.line(frame, (0,0), (a,c), (0, 0, 255), 2)
#     cv2.line(frame, (a,c), (b,c), (0, 0, 255), 2)
#     cv2.line(frame, (b,c), (w,0), (0, 0, 255), 2)
#     cv2.line(frame, (a,c), (a,d), (0, 0, 255), 2)
#     cv2.line(frame, (a,d), (0,h), (0, 0, 255), 2)
#     cv2.line(frame, (a,d), (b,d), (0, 0, 255), 2)
#     cv2.line(frame, (b,d), (w,h), (0, 0, 255), 2)
#     cv2.line(frame, (b,c), (b,d), (0, 0, 255), 2)#以上八行为区域判定
#     cv2.line(frame, (e,0), (f,0), (0, 255, 0), 2)
#     cv2.line(frame, (e,h), (f,h), (0, 255, 0), 2)
#     cv2.line(frame, (e,0), (e,h), (0, 255, 0), 2)
#     cv2.line(frame, (f,0), (f,h), (0, 255, 0), 2)
#     return frame